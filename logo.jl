...
import Term: vstack, hstack, install_stacktrace
...
""",
title="Term.jl", title_style=indigo, width=75
)

# create "spacers" and stack renderables
hspacer = Spacer(green.measure.w/2 + 1, green.measure.h)
circles = Spacer(green.measure.w*2 + 2, 1) / (hspacer *  green * hspacer) / (red * Spacer(2, purple.measure.h) * purple)

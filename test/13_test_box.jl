...
@testset "\e34mBOX" begin
    ...
    # test get row
    @test get_row(ROUNDED, [3], :top) == get_row(ROUNDED, 3, :top) == "╭───╮"
    ...
    left = get_title_row(:top, Term.box.ROUNDED, "test", width=22, 
                            justify=:left, title_style="blue", style="red")
    @test left.measure.w == 22
    @test left.text == "\e[31m╭────\e[39m \e[34m\e[34mtest\e[39m\e[39m\e[39m \e[31m─────────╮\e[39m\e[39m"

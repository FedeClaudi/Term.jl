...
@testset "\e[34mHIGHLIGHT" begin
    ...
    "{red bold}❯{/red bold} {white}7{/white}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"this is ::Int64\"{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  } {(165, 214, 167)    }\"this is \\e[38;2;206;147;216m::Int64\\e[39m\"{/(165, 214, 167)    }\n  {grey39}8{/grey39} \n  {grey39}9{/grey39}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"print\"{/(165, 214, 167)    }{(252, 116, 116)    },{/(252, 116, 116)    } {(165, 214, 167)    }:func{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 9" ⋯ 166 bytes ⋯ "est {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"1 + 2\"{/(165, 214, 167)    }{(252, 116, 116)    },{/(252, 116, 116)    } {(165, 214, 167)    }:code{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  } {(165, 214, 167)    }\"\\e[3m\\e[38;2;255;238;88m1 + 2\\e[23m\\e[39m\"{/(165, 214, 167)    }\n  {grey39}12{/grey39} \n  {grey39}13{/grey39}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"this 1 + `test`\"{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  }"
    # end
end

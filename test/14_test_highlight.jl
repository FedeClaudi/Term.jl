...
@testset "\e[34mHIGHLIGHT" begin
    ...
    @test highlight("this 1 + `test`") == "this \e[38;2;144;202;249m1\e[39m \e[38;2;239;83;80m+\e[39m \e[3m\e[38;2;255;238;88m`test`\e[23m\e[39m"
    ...
    if !Sys.iswindows()
        ...
        @test load_code_and_highlight("14_test_highlight.jl", 7) == "{red bold}❯{/red bold} {white}7{/white} \n  {grey39}8{/grey39}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"this is ::Int64\"{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  } {(165, 214, 167)    }\"this is \\e[38;2;206;147;216m::Int64\\e[39m\"{/(165, 214, 167)    }\n  {grey39}9{/grey39} \n  {grey39}10{/grey39}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"print\"{/(165, 214, 167)    }{(252, 116, 116)    },{/(252, 116, 116)    } {(165, 214, 167)    }:func{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  } {(165, 214, 167)    }\"\\e[38;2;255;238;88mprint\\e[39m\"{/(165, 214, 167)    }\n  {grey39}11{/grey39} \n  {grey39}12{/grey39}  @test {(255, 245, 157)  bold  }highlight{/(255, 245, 157)  bold  }{(252, 116, 116)    }({/(252, 116, 116)    }{(165, 214, 167)    }\"1 + 2\"{/(165, 214, 167)    }{(252, 116, 116)    },{/(252, 116, 116)    } {(165, 214, 167)    }:code{/(165, 214, 167)    }{(252, 116, 116)    }){/(252, 116, 116)    } {(252, 98, 98)  bold  }=={/(252, 98, 98)  bold  } {(165, 214, 167)    }\"\\e[3m\\e[38;2;255;238;88m1 + 2\\e[23m\\e[39m\"{/(165, 214, 167)    }\n  {grey39}13{/grey39} "
